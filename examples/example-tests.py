...
optimizer = Optimizer(algorithm="SVC", direction="maximize", n_trials=20, cv=3, scoring="accuracy", random_state=42, show_progress_bar=True)
...
optimizer = Optimizer(algorithm="RandomForestRegressor",
                      direction="maximize",
                      n_trials=20,
                      cv=3,
                      scoring="r2",
